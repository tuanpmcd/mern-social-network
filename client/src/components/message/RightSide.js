  ...
  return (
    <>
      <div style={{ cursor: 'pointer' }} >
        {
          ...
          <UserCard user={user}>
            <div>
              <i className="fas fa-phone-alt text-info"
                onClick={handleAudioCall} />

              <i className="fas fa-video mx-3 text-info"
      ...
      <div className="chat_container"
        style={{ height: media.length > 0 ? 'calc(100% - 190px)' : '' }}
      >
      ...
      <form className="chat_input" onSubmit={handleSubmit} >
        ...
        <div className="file_upload">
          <i className="fas fa-image text-info mr-3" />
          <input type="file" name="file" id="file"
            multiple accept="image/*,video/*" onChange={handleChangeMedia} />
        </div>

        <button type="submit" className="material-icons text-info"
